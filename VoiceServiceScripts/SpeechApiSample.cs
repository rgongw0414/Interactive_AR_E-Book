...
public class SpeechApiSample : MonoBehaviour
{
    ...
    public string SendAudioFile(String apiName, String seqValue, Boolean finished, String filePath, Boolean compressed)
    {
        ...
        Debug.Log("The path of the audio file : " + filePath);
        ...
        Debug.Log("Sending 'HTTP POST' request to URL : " + httpURL.ToString());
    ...
    public string SendAudioFile(String apiName, String seqValue, Boolean finished, byte[] audioFile, Boolean compressed)
    {
        string result;
        ...
        using (Stream requestStream = request.GetRequestStream())
        {
            requestStream.Write(audioFile, 0, audioFile.Length);
        }
    ...
    public string GetRecognitionResult(string apiName, String seqValue)
    {
        ...
        Debug.Log("Sending 'HTTP GET' request to URL : " + httpURL.ToString());
        HttpWebRequest request = HttpWebRequest.Create(httpURL.ToString()) as HttpWebRequest;
        request.Method = "GET";
